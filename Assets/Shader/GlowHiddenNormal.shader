Shader "STShader/GlowHiddenNormal"{
	Properties {
		[HDR]
		_Color ("Glow Color", Color) = (1,0,0,1)
		_Outline ("Outline width", Range (0, 0.25)) = .005
	...
	voutGlow vertPassGlobal(vinGlow v, fixed Occlusion) {
		...
		o.pos.z += 0.001;
		o.color = fixed4(_Color.r,_Color.g,_Color.b,_Opacity/10.0);
		return o;
	}		
	...
	SubShader {				
		...
		/*Pass{
			...
			v2f vert(appdata_base v) {
				...
				o.grabPos.xy = TransformStereoScreenSpaceTex(o.grabPos.xy, o.grabPos.w);
#endif
				return o;
			}
